...
export class WeatherservicesService {
  ...
  constructor(private HttpClient:HttpClient) {
   ...
   //https://api.openweathermap.org/data/2.5/weather?q=jaen&appid=c50753471a70495326473300eecc3c5b
    ...
    buscarDetalles(cadena:string):Observable<Weather>{
      return this.HttpClient.get<Weather>(`https://api.openweathermap.org/data/2.5/forecast?q=${cadena}&lang=${this.lang}&appid=${this.apikey}`)
    }
}
